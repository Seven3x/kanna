...
import type { ChatAttachment, ProjectSkillSummary } from "../../../shared/types"
import { createMarkdownComponents, createSkillMentionsRemarkPlugin } from "./shared"
...
export function UserMessage({ content, attachments = [], skills = [] }: Props) {
